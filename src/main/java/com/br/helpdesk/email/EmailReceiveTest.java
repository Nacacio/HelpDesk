...
public class EmailReceiveTest {
     ...
     *
     * @param isImap - if true then we are reading messages from the IMAP
     * server, if no then read from the POP3 server.
     */
    private static void readEmails(boolean isImap) {
        ...
        try {
           ...
           // Set the server depending on the parameter flag value  
            ...
            //VALORES DO SERVIDOR 
            store.connect("imap.gmail.com", "andresulivam@gmail.com", "26240241");
